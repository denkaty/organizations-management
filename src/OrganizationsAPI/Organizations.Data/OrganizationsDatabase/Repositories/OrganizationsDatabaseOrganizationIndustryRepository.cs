...
namespace Organizations.Data.OrganizationsDatabase.Repositories
{
	public class OrganizationsDatabaseOrganizationIndustryRepository : IOrganizationsDatabaseOrganizationIndustryRepository
	{
		...
		public OrganizationIndustry Get(string id)
		{
			throw new NotImplementedException();
		}
		...
		public ICollection<OrganizationIndustry> GetAll(Func<OrganizationIndustry, bool> predicate)
		{
			throw new NotImplementedException();
		}

		public void Update(string id, OrganizationIndustry entity)
		{
			throw new NotImplementedException();
		}
	}
